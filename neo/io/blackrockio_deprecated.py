# -*- coding: utf-8 -*-
"""
Deprecated module for reading analog data from binary files in Blackrock format.
"""
...
class BlackrockIO(BaseIO):
    ...
    def __init__(self, filename, full_range=8192.*pq.mV) :
        ...
        **Arguments**
        ...
        print "This is version of BlackrockIO is deprecated. Please use blackrockio.BlackrockIO."
        print "which offers support for both analog and time stamp data. However, writing capabilities are not yet implemented."
