...
class TestNeuralynxRawIO(
    ...
    def test_read_ncs_files_sideeffects(self):
        ...
        self.assertListEqual(
            rawio._timestamp_limits, [(26122557633, 26162525633), (26366360633, 26379704633)]
        )
        ...
        self.assertListEqual(
            rawio._timestamp_limits,
            [(8408806811, 8427831990), (8427832053, 8487768498), (8487768561, 8515816549)],
        )
...
class TestNcsSectionsFactory(TestNeuralynxRawIO, unittest.TestCase):
    ...
    def test_ncsblocks_partial(self):
        ...
        data0 = np.memmap(
            filename, dtype=NeuralynxRawIO._ncs_dtype, mode="r", offset=NlxHeader.HEADER_SIZE
        )
    ...
    def test_block_start_and_end_times(self):
        ...
        nb = NcsSectionsFactory.build_for_ncs_file(data0, hdr)
        self.assertListEqual(
            [blk.startTime for blk in nb.sects], [8408806811, 8427832053, 8487768561]
        )
        self.assertListEqual(
            [blk.endTime for blk in nb.sects], [8427831990, 8487768498, 8515816549]
        )
