...
class CommonTests(BaseTestIO, unittest.TestCase):
    ...
    def test_inputs_V23(self):
        ...
        # recording
        too_large_tstop = block.segments[0].analogsignals[0].t_stop + 1 * Units.s
        block = b.read_block(
            n_starts=[-100 * Units.ms], n_stops=[too_large_tstop],
        ...
        block = b.read_block(
            n_starts=[None, 3000 * Units.ms], n_stops=[1000 * Units.ms, None],
