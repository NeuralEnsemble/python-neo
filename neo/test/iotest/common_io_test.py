...
class BaseTestIO:
    ...
    def setUp(self):
        ...
        self.io_readandwrite = list(
            set(self.ioclass.readable_objects) & set(self.ioclass.writeable_objects)
        )
        # these objects can be either written or read
        self.io_readorwrite = list(
            set(self.ioclass.readable_objects) | set(self.ioclass.writeable_objects)
        )
    ...
    def able_to_write_or_read(self, writeread=False, readwrite=False):
        ...
        # genericaly.
        if (
            self.higher in self.ioclass.read_params
            and len(self.ioclass.read_params[self.higher]) != 0
        ):
            return False
    ...
    def create_file_reader(
        self, filename=None, return_path=False, clean=False, target=None, readall=False
    ):
        """
    ...
    def create_file_writer(self, filename=None, return_path=False, clean=False, target=None):
        """
    ...
    def read_file(
        self, filename=None, return_path=False, clean=False, target=None, readall=False, lazy=False
    ):
        """
    ...
    def iter_readers(
        self, target=None, readall=False, return_path=False, return_ioobj=False, clean=False
    ):
        """
