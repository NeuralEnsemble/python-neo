...
from neo.io.hdf5io_new import NeoHdf5IO


class ReadOldNeoHdf5IOTest(unittest.TestCase):
    """
    ...
    def test_read_with_merge(self):
        test_file = "/Users/andrew/dev/neo/files_for_testing_neo/neo_hdf5_example.h5"
