...
class TestUnit(unittest.TestCase):
    ...
    def test__merge(self):
        ...
        assert_same_sub_schema(self.trains1a + self.trains2, unit1a.spiketrains)
    ...
    def test__children(self):
        ...
        self.assertEqual(self.unit1._single_parent_containers, ("channel_index",))
        ...
        assert_same_sub_schema(list(self.unit1._single_children), self.trains1a)

        assert_same_sub_schema(list(self.unit1.data_children), self.trains1a)

        assert_same_sub_schema(list(self.unit1.data_children_recur), self.trains1a)
    ...
    def test__filter_single_attribute_nodata_norecur(self):
        targ = []
        res0 = self.targobj.filter(name=self.trains1a[0].name, data=False, recursive=False)
        assert_same_sub_schema(res0, targ)
    ...
    def test__filter_single_attribute_container_norecur(self):
        targ = [self.trains1a[0]]
        res0 = self.targobj.filter(name=self.trains1a[0].name, container=True, recursive=False)
        assert_same_sub_schema(res0, targ)
    ...
    def test__filter_single_attribute_nodata_container(self):
        targ = []
        res0 = self.targobj.filter(name=self.trains1a[0].name, data=False, container=True)
        assert_same_sub_schema(res0, targ)
    ...
    def test__filter_single_attribute_nodata_container_norecur(self):
        ...
        res0 = self.targobj.filter(
            name=self.trains1a[0].name, data=False, container=True, recursive=False
        )
        assert_same_sub_schema(res0, targ)
