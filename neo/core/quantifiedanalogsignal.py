...
class QuantifiedAnalogSignal(BaseNeo, pq.Quantity):
    ...
    Usages:
    >>> a = QuantifiedAnalogSignal([1,2,3])
    >>> b = QuantifiedAnalogSignal([4,5,6], sampling_period=42.)
    >>> c = QuantifiedAnalogSignal([1,2,3], t_start=42.)
    >>> d = QuantifiedAnalogSignal([1,2,3], t_start=42., sampling_rate=1/42.])
    >>> e = QuantifiedAnalogSignal([1,2,3], unit='ms')
    ...
    def __new__(subtype, signal, dtype=None, copy=True, t_start=0., sampling_rate=None, sampling_period=None, unit='ms'):
        ...
        if isinstance(signal, QuantifiedAnalogSignal):
            return signal
    ...
    def sampling_period(self):
        # do it in the other sense
        return 1./self.sampling_rate

    def set_sampling_period(self, value):
        self.sampling_rate = 1./value

    sampling_period = property(fget=sampling_period, fset=set_sampling_period)
