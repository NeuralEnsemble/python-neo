...
class RecordingChannelGroup(BaseNeo):
    """
    A RecordingChannelGroup is a container inside a Block of some 
    RecordingChannel objects. It is useful for grouping channels that share
    something in common: for instance, the channels on a tetrode.
