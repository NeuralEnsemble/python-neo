...
class TdtRawIO(BaseRawIO):
        ...
        for seg_index, segment_name in enumerate(segment_names):
            ...
            if info_channel_groups is None:
                ...
                assert np.array_equal(
                    info_channel_groups, _info_channel_groups
                ), "Channels differ across segments"
        ...
        for group_id, info in enumerate(info_channel_groups[keep]):
            ...
            for c in range(info["NumChan"]):
                ...
                signal_channels.append(
                    (chan_name, chan_id, sampling_rate, dtype, units, gain, offset, group_id)
                )
    ...
    def _spike_count(self, block_index, seg_index, unit_index):
        ...
        tsq = self._tsq[seg_index]
        mask = self._get_mask(
            tsq, seg_index, EVTYPE_SNIP, store_name, chan_id, unit_id, None, None
        )
    ...
    def _get_spike_timestamps(self, block_index, seg_index, unit_index, t_start, t_stop):
        ...
        tsq = self._tsq[seg_index]
        mask = self._get_mask(
            tsq, seg_index, EVTYPE_SNIP, store_name, chan_id, unit_id, t_start, t_stop
        )
