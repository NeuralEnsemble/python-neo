...
# sphinx-quickstart on Thu Oct  8 14:56:36 2009.
#
...
sys.path.append(os.path.abspath('../../../neo'))
...
project = u'neo'
copyright = u'2009, Samuel Garcia, Pierre Yger, Andrew Davison, Eilif Muller, Luc Estebanez'
...
latex_documents = [
  ('index', 'neo.tex', u'neo Documentation',
   u'Samuel Garcia, Pierre Yger, Andrew Davison, Eilif Muller, Luc Estebanez', 'manual'),
]
