...
from neo.io import PyNNIO
from neo.core import *
from numpy import *


class PyNNIOTest(unittest.TestCase):
    
    def testOpenFile1(self):
        io  = PyNNIO(filename = 'datafiles/File_pynntext_1.pynn',)
        seg = io.read()
    ...
    def testOpenFile4(self):
        io  = PyNNIO(filename = 'datafiles/File_pynntext_2.pynn',)
        seg = io.read()
