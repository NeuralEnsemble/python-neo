...
class SpikeTrainListTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.spk = SpikeTrainList(spiketrains=self.spikes)
    ...
    def testTime_Slice(self):
        spk     = SpikeTrainList(spiketrains=self.spikes, t_start=0)
    ...
    def testSelect_Ids(self):
        ...
        spk = SpikeTrainList(spks, t_start=0, t_stop=1000)
